...
final class CreateAccountViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            fullNameTextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            fullNameTextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24),
            ...
            // Sign in label
            signInLabel.topAnchor.constraint(equalTo: googleButton.bottomAnchor, constant: 24),
            signInLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            signInLabel.bottomAnchor.constraint(lessThanOrEqualTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -16)
        ])
    }
