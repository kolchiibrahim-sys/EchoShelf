...
final class LibraryCoordinator: Coordinator {
    ...
    func start() {
        let vc = LibraryViewController(viewModel: LibraryViewModel())
        vc.coordinator = self
    ...
    func confirmDelete(_ item: LibraryItem, from vc: UIViewController, onConfirm: @escaping () -> Void) {
        ...
        alert.addAction(UIAlertAction(title: "Remove", style: .destructive) { _ in onConfirm() })
